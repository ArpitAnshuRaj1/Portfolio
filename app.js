...
window.addEventListener("scroll", ()=>{
  ...
  laptop[0].style.transform = `translateX(calc(630vh - ${offsetY}px))`
  phones[1].style.transform = `translateX(calc(750vh - ${offsetY}px))`
  phones[2].style.transform = `translateX(calc(890vh - ${offsetY}px))`
  laptop[1].style.transform = `translateX(calc(1010vh - ${offsetY}px))`
})